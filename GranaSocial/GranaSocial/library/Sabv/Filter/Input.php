 ...
 * @version    $Id: Input.php,v 1.2 2008/10/10 14:05:07 italo.pereira Exp $
 */
...
/**
 * Classe utilizada para validação e filtragem dos dados utilizando o Zend_Validate.
 * Classe feita a partir da classe Zend_Filter_Input, para permitir alteração dos
 * validadores sem a necessidade de alterar diretamente o Zend framework.
 * 
 * @category   Zend
 * @package    Zend_Filter
 * @copyright  Copyright (c) 2005-2008 Zend Technologies USA Inc. (http://www.zend.com)
...
class Sabv_Filter_Input
{
    ...
    protected $_defaults = array(
        ...
        self::MISSING_MESSAGE     => "Campo é requerido, mas não foi informado.",
        self::NOT_EMPTY_MESSAGE   => "O campo não pode ser vazio.",
        ...
        if (!isset($this->_loaders[$type])) {
            switch ($type) {
                case self::FILTER:
                    ...
                    break;
                case self::VALIDATE:
                    $prefixSegment = 'Sabv_Validate_';
                    $pathSegment   = 'Sabv/Validate/';
                    break;
                default:
                    require_once 'Zend/Filter/Exception.php';
