 ...
 * @version    $Id: Between.php,v 1.1 2008/07/17 13:30:40 delano Exp $
 */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Sabv_Validate_Between extends Zend_Validate_Abstract
{
    /**
    ...
    protected $_messageTemplates = array(
        self::NOT_BETWEEN        => "'%value%' não é igual ou está entre os valores '%min%' e '%max%'",
        self::NOT_BETWEEN_STRICT => "'%value%' não está entre '%min%' e '%max%'"
    );
