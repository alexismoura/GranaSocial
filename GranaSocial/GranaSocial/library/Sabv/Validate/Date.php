 ...
 * @version    $Id: Date.php,v 1.3 2008/09/03 17:33:40 gabriel Exp $
 */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Sabv_Validate_Date extends Zend_Validate_Abstract
{
    /**
    ...
    protected $_messageTemplates = array(
        self::NOT_YYYY_MM_DD => "'%value%' não está no formato DD/MM/AAAA.",
        self::INVALID        => "'%value%' não é uma data válida.",
        self::FALSEFORMAT    => "'%value%' não está no formato correto.",
