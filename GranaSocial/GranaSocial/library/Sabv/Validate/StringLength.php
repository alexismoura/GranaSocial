 ...
 * @version    $Id: StringLength.php,v 1.1 2008/07/17 13:30:41 delano Exp $
 */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Sabv_Validate_StringLength extends Zend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        self::TOO_SHORT => "'%value%' deve ter no mínimo %min% caracteres",
        self::TOO_LONG  => "'%value%' tem mais que %max% caracteres"
    );
