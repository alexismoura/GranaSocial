 ...
 * @version    $Id: Alpha.php,v 1.3 2008/08/18 14:59:56 italo.pereira Exp $
 */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Sabv_Validate_Alpha extends Zend_Validate_Abstract
{
    /**
    ...
    protected $_messageTemplates = array(
        self::NOT_ALPHA    => "'%value%' não é um caracter do alfabeto.",
